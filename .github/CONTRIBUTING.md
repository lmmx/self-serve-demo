...
Firstly thank you for your interest in contributing to _self-serve-demo_!
...
Next get the latest checkout of the _self-serve-demo_ repository:

```sh
git clone git@github.com:lmmx/self-serve-demo.git
```

Change into the newly created directory and **after activating your virtual environment**
install an editable version of self-serve-demo along with its tests requirements:
...
Thank you for considering contribution to _self-serve-demo_!
